...
class StorePatientCompanionSocialSecurityRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'companions.*.document_number' => 'nullable|string',
            ...
            'companions.*.email' => 'nullable|max:100',
            ...
            'patient.document_number' => 'required|string|unique:patients,document_number',
