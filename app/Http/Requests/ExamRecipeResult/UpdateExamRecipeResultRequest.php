...
class UpdateExamRecipeResultRequest extends FormRequest
{
    public function rules()
    {
        return [
            'exam_recipe_id' => 'sometimes|exists:exam_recipes,id',
            'uploaded_by_user_id' => 'sometimes|exists:users,id',
            'result_minio_id' => 'sometimes|string|max:500',
            'date' => 'sometimes|date',
